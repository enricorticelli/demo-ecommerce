...
Conventions for style, naming, and non-architectural patterns in demo-ecommerce.
...
- [G-DDD: Backend DDD conventions](./backend-ddd.md)
- [G-ENDPOINT: API endpoint conventions](./endpoint-conventions.md)
- [G-EVENTS: Integration event conventions](./integration-events.md)
- [G-MODULE: Module baseline conventions](./module-baseline-conventions.md)
